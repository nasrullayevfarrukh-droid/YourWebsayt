...
export function Navbar() {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-[60] pt-2.5 sm:pt-4">
        <Container>
          <div
            className={cn(
              "flex items-center justify-between rounded-[28px] px-3.5 py-2.5 transition-all duration-500 sm:rounded-[32px] sm:px-5 sm:py-3",
              isScrolled
          ...
          >
            ...
            <button
              ...
              className="rounded-full border border-white/10 bg-white/[0.03] p-2.5 text-[var(--color-text)] lg:hidden"

...
export function PageHero({ eyebrow, title, description, aside }: PageHeroProps) {
  return (
    <section className="relative overflow-hidden pt-24 sm:pt-28 lg:pt-36">
      ...
      <Container className="relative">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(16rem,20rem)] lg:items-end">
          <Reveal>
            ...
            <h1 className="max-w-4xl text-balance font-display text-[2.85rem] leading-[0.94] tracking-[-0.05em] text-[var(--color-text)] sm:text-6xl lg:text-7xl">
              {title}
            </h1>
